...
def reg_user():
    ...
    while run:
        ...
        if new_password == confirm_password:
            ...
            with open("Classes/21/user.txt", "w") as out_file:
                user_data = []
...
if not os.path.exists("Classes/21/tasks.txt"):
    with open("Classes/21/tasks.txt", "w") as default_file:
        pass

with open("Classes/21/tasks.txt", 'r') as task_file:
...
if not os.path.exists("Classes/21/user.txt"):
    with open("Classes/21/user.txt", "w") as default_file:
        default_file.write("admin;password")

# Read in user_data
with open("Classes/21/user.txt", 'r') as user_file:
...
: ''').lower()
    ...
    if menu == 'r':
       ...
       view_all()
        ...
        with open('Classes/21/task_overview.txt', 'r+') as f:
            for line in f:
                print(line)
        print()
        with open('Classes/21/user_overview.txt','r+') as f:
            for line in f:
                print(line) 
